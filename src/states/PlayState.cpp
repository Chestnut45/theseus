...
void PlayState::CreatePlayer()
{
    ...
    // Add inventory
    auto& inventory = m_pPlayerObject->AddComponent<PlayerInventoryComponent>(16, 4, "data/textures/ItemIcons-Sheet.png", glm::vec2(32.0f, 32.0f));
    ...
    MerchantInventoryComponent* pMerchant = &m_pPlayerObject->AddComponent<MerchantInventoryComponent>(16, 4, "data/textures/ItemIcons-Sheet.png", glm::vec2(32.0f, 32.0f), "Merchant Guy", 0.1f, 50);
    pMerchant->FillInventoryFromFile("data/test_chest_contents.yaml");
    DispensaryInventoryComponent* pDispensary = &m_pPlayerObject->AddComponent<DispensaryInventoryComponent>(16, 4, "data/textures/ItemIcons-Sheet.png", glm::vec2(32.0f, 32.0f));
