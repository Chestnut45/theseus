...
void PlayerController::HandlePlayerInput(float delta)
{
        ...
        !m_isHoldingObject)
    {
        if (m_pCurrentWeapon->GetName() == "Zeus' Wrath")
        {
            ...
            auto& light = lightObj.AddComponent<LightComponent>(glm::vec4(0.9f, 0.9f, 0.65f, 0.8f), 225.0f, true);
            ...
            wolf::Audio::Play("data/sounds/sfx_lightning.wav", 0.6f, rng.NextInt(-8000, 0));
