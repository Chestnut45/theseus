...
void PlayerController::ApplyDamageToEnemy()
{
    ...
    switch(this->m_pCurrentWeapon->GetWeaponType())
    {
        ...
        case WeaponType::BOW:
        {
            ...
            auto& projectileADComponent = projectile.AddComponent<AttackDamageComponent>(
                m_pCurrentWeapon->GetDamage(),
                m_pColliderManager,
                WeaponType::BOW  // Weapon-based attack
            );
        ...
        case WeaponType::SWORD:
        {
            ...
            auto& meleeADComponent = melee.AddComponent<AttackDamageComponent>(
                m_pCurrentWeapon->GetDamage(),
                m_pColliderManager,
                WeaponType::SWORD  // Weapon-based attack
            );
