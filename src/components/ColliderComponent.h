...
public:
    ...
    ColliderComponent(ColliderType p_collider_type, bool p_doc , bool p_relativity, bool p_wall_hitbox = false, wolf::GameObjectID p_ignore_id = -1);   
